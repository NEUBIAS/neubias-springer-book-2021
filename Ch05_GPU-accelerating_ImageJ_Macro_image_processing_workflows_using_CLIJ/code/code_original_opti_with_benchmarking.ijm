...
benchmarking_file = project_root_folder + "/benchmarking/original_opti_analysis_timing.xls";
...
for (iteration = 0; iteration < 100; iteration++) {
	...
	target_xls_filename = project_root_folder + "benchmarking/original_opti_analysis_" + iteration + ".xls";
